...
class YZPlayerView: UIView {
    ...
    private func setupEvent() {
        NotificationCenter.default.addObserver(self, selector: #selector(pause), name: NSNotification.Name(rawValue: "videoVCDidDisappear"), object: nil)
        // 监听屏幕旋转
    ...
    func play() {
        ...
        setupEvent()
        addTarget()
       NotificationCenter.default.post(name: NSNotification.Name(rawValue: "LBControlReceived"), object: nil, userInfo: ["event":"暂停"])
    }
